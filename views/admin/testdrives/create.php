<?php $this->layout('layouts/admin', ['title' => 'Novo Testdrive']) ?>

<?php $this->start('body') ?>

<div class="card shadow-sm" id="formView">
    <?php $this->insert('partials/admin/form/header', ['title' => 'Novo Testdrive']) ?>
    <div class="card-body">
        <form method="post" action="/admin/testdrives/store" class="">
            <div class="row">
...
```
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control" id="data_testdrive" name="data_testdrive"
                       value="<?= $this->e(($old['data_testdrive'] ?? date('Y-m-d'))) ?>" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control" id="status" name="status" required>
                    <?php $current_status = $old['status'] ?? 'pendente'; ?>
